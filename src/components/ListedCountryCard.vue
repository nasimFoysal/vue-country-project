...
<template>
  <div class="border border-gray-300 mb-8 rounded-lg p-5 flex  gap-6">
    ...
    <div class="font-semibold text-lg space-y-4">
     ...
     <div>
       <RouterLink :to="`/country/${country.cca3}`"
                   class="py-2 px-6  bg-blue-400 text-white font-bold rounded-lg w-[75%]"
